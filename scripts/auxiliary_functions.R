...
# Auxiliary functions
##################################################################################################
extract_features <- function(file_name,new_name,features_file_name){
  met_data <- read.table(file_name,header = TRUE,stringsAsFactors = FALSE)
  features <- read.table(features_file_name,stringsAsFactors = FALSE)
...
########################
extract_features_results <- function(file_name,new_name,features_file_name){
  met_data <- read.table(file_name,header = TRUE,stringsAsFactors = FALSE)
  features <- read.table(features_file_name, stringsAsFactors = FALSE)
  features <- as.vector(features$V1)
  features <- as.character(features)
